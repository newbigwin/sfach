...
async def admin_manual(callback: CallbackQuery):
    ...
    text = (
        ...
        "/start — главное меню\n"
        "/help — помощь\n"
        "/profile — свой профиль (или ответом — профиль другого)\n"
        ...
        "/clan_delete — удалить клан (лидер/админ)\n"
        ...
        "Запланированные посты — авто-публикация по расписанию\n"
        "Статистика — аналитика бота\n"
        "История баланса — просмотр операций\n"
